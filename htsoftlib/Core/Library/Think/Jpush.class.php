...
//使用示例
    ...
    //组装需要的参数
    //$receive = 'all';     //全部
    $receive = array('tag'=>array('10','2588','9527'));      //标签
...
class Jpush{
    ...
    private $app_key = '934810d879bcc36bd64fbf83';            //待发送的应用程序(appKey)，只能填一个。
    private $master_secret ='1235255880e8b8ea8e0b94d2';        //主密码
