...
//项目相对路径，不可更改
define('SPAPP_PATH',  SITE_PATH.'htsoftlib/');
//
...
//版本号
define("HTSOFT_VERSION", 'X1.6.0');

define("HTSOFT_CORE_TAGLIBS", 'cx,Common\Lib\Taglib\TagLibSpadmin,Common\Lib\Taglib\TagLibHome');
